...
export function Footer() {
  return (
    <footer className="border-t border-border bg-[#faf5ff]">
      <div className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-3 max-w-sm leading-relaxed text-muted-foreground">
              The easiest way to connect with verified vendors, receive competitive quotations, and book seamlessly for any event.
            </p>
        ...
        <div className="mt-12 border-t border-border pt-8 text-center text-sm text-muted-foreground">
          {`\u00A9 ${new Date().getFullYear()} EventVendor. All rights reserved.`}
        </div>
      </div>
    </footer>
  );
